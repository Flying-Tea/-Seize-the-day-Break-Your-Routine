...
import SeizeDay from './assets/SeizeDay.gif'
      ...
      <div className="pt-20 px-2">
        <div className="flex flex-col lg:flex-row items-center justify-between px-6 lg:px-20 py-10 gap-10 bg-yellow-500 rounded-lg shadow-lg">
          <div className="text-center lg:text-left text-gray-800 ">
            ...
            <a href="/Demo" className="bg-purple-500 hover:bg-teal-400 text-white font-semibold py-3 px-6 rounded-lg transition-colors duration-300">Explore Now</a>
          </div>
          <div>
            <img src={DeadPoets} alt="Dead Poets Society Cover" className="w-full max-w-md rounded-lg shadow-lg bg-amber-400" />
          </div>
        </div>
        <div className="mt-5 text-center bg-yellow-500 rounded-lg shadow-lg p-10">
          ...
          <a href="/Demo" className="bg-purple-500 hover:bg-teal-400 text-white font-semibold py-3 px-6 rounded-lg transition-colors duration-300">Explore Now</a>
          <img src={SeizeDay} alt="Seize the Day" className="w-full max-w-md rounded-lg shadow-lg bg-amber-400 mt-10 mx-auto" />
          <p className="text-lg mt-2 text-gray-600"><b>Gif of John Keatings saying "Seize the Day!"</b></p>
        </div>
        <div className="mt-5 text-center bg-yellow-500 rounded-lg shadow-lg p-10">
          ...
          <a href="/about" className="bg-green-500 hover:bg-teal-400 text-white font-semibold py-3 px-6 rounded-lg transition-colors duration-300">Learn More</a>
        </div>
      </div>
      <div className='mt-5'>
