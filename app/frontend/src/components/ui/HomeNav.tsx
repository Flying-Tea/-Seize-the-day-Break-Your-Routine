...
import { ReuseButton } from "./MyButton.tsx";
...
export function HomeNavBar() {
    ...
    <nav className="fixed top-0 w-full z-50 bg-slate-950/20 backdrop-blur-sm border-b transition-all duration-300">
        ...
        <div className="hidden md:flex gap-4 items-center">
            ...
            intent="primaryButton"
            href="/demo"
            className="flex items-center gap-2 border-2 bg-purple-500 p-2 rounded-lg hover:bg-teal-400"
            >
                <SquareLibrary /> <span>Demo</span>
            ...
            intent="primaryButton"
            href="/about"
            className="flex items-center gap-2 border-2 bg-green-500 p-2 rounded-lg hover:bg-teal-400"
            >
